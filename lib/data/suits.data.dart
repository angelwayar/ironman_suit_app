...
import 'package:ironman_suits_app/config/colors/color.dart';

class SuitsData {
  final mark1Suit = const Suit(
      imagePaths: ['assets/mark1@2x.png'],
      name: 'Mark I',
      description: 'The Mark I (Mark 1), is the first Iron Man suit built and created by Tony Stark. It was built in the initial events of the live-action film, Iron Man. The suit was later used as a model for Obadiah Stane\'s Iron Monger...\n\n' +
  ...
  final mark7Suit = const Suit(
      imagePaths: ['assets/mark7@2x.png', 'assets/mark7v2@2x.png'],
      name: 'Mark VII',
      description: 'The Mark VII (Mark 7), is a Fully Loaded Rapid Deployment Suit, and was the seventh suit created by Tony Stark, to surpass the Mark VI, sometime between the events of Iron Man 2 and The Avengers.\n\n' +
  ...
  final mark8Suit = const Suit(
      imagePaths: ['assets/mark8@2x.png'],
      name: 'Mark VIII',
      description: 'The Mark VIII (Mark 8), is a Fully Loaded Suit Upgrade, and was the eighth suit created and built by Tony Stark, to surpass the Mark VII, sometime after the events of The Avengers.\n\n' +
